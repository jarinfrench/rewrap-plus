...
string literals, and (for Markdown and LaTeX) ordinary prose to a
...
- **Jarin French** - product design, all architectural and process
  decisions, scope/direction, and verification.
- **Claude** - nearly all implementation: the engine, every language
  adapter, the VSCode extension and CLI glue, the test suites, and most
